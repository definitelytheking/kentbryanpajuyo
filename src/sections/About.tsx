...
import happyEmoji from "@/assets/images/Kenthappy.png";
        ...
        <div className="mt-20 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:grid-cols-3">
            ...
            <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
              ...
              />
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-20 rounded-full  after:content-[''] after:absolute after:inset-0 after:outline after:outline-2 after-outline-offset-2
            ...
            from-emerald-300 to-sky-400 -z-10"
                ></div>
                <Image src={happyEmoji} alt="happy emoji" className="size-20" />
              </div>
            </Card>
          </div>
        </div>
